 ...
 * Item
 *
 * @ORM\Table(name="item", indexes={@ORM\Index(name="Id_horse", columns={"Id_horse"}), @ORM\Index(name="Id_gamer", columns={"Id_gamer"}), @ORM\Index(name="Id_infrastructure", columns={"Id_infrastructure"})})
 * @ORM\Entity
 */
class Item
{
